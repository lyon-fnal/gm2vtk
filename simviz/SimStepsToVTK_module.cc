...
class gm2viz::SimStepsToVTK : public art::EDAnalyzer {
public:
...
gm2viz::SimStepsToVTK::SimStepsToVTK(fhicl::ParameterSet const & p)
  :
  EDAnalyzer(p),
  geantTrackRecordInputTag_( p.get<std::string>("geantTrackRecordInputTag", "artg4:KeepStepsAction") )
{}

void gm2viz::SimStepsToVTK::beginJob() {
...
DEFINE_ART_MODULE(gm2viz::SimStepsToVTK)
